    ...
    <header id="header" class="d-flex align-items-center">
        ...
        <h1 class="logo"><a href="{{route('admin.home')}}">Hospital privado de ojos<span>.</span></a></h1>
        ...
        <nav id="navbar" class="navbar">
            ...
            <li><a class="nav-link scrollto" href="{{route('admin.noticias')}}">Gestion Noticias</a></li>
            {{-- <li><a class="nav-link scrollto" href="#">Gestion Perfil</a></li> --}}
