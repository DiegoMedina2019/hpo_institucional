    ...
    public function dias(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if (count( $arr) > 0) {
                ...
                return response()->json([
                    'err' => 'Lo sentimos actualmente no podremos asignar este turno. Pero puedes comunicarte con nosotros para resolverlo enviandonos un <a href="https://wa.me/543813688983?text=Hola%20necesito%20ayuda%20para%20generar%20un%20turno" target="_blank">Whatsapp</a>',
                    'status' => false
                ]);
            }               
